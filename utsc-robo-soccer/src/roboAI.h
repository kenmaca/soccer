...
/*
struct PID createPID (double Kp, double Ki, double Kd, double period) {
...
// definition for the function pointer
typedef double (*fptr)(double);

// helper function that calculates the spline and return a 
// function pointer of type above
void getSplineCoef (struct RoboAI *ai);
