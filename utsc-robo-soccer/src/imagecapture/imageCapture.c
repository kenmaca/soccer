...
{ 
 ...
 if (key=='i') {if (DIR_FWD==0) {DIR_FWD=1; DIR_L=0; DIR_R=0; DIR_BACK=0; drive_speed(60);} else {DIR_FWD=0; all_stop();}}
 if (key=='j') {if (DIR_L==0) {DIR_L=1; DIR_R=0; DIR_FWD=0; DIR_BACK=0; pivot_left_speed(60);} else {DIR_L=0; all_stop();}}
 if (key=='l') {if (DIR_R==0) {DIR_R=1; DIR_L=0; DIR_FWD=0; DIR_BACK=0; pivot_right_speed(60);} else {DIR_R=0; all_stop();}}
 if (key=='k') {if (DIR_BACK==0) {DIR_BACK=1; DIR_L=0; DIR_R=0; DIR_FWD=0; reverse_speed(60);} else {DIR_BACK=0; all_stop();}}
